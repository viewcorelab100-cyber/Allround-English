                ...
                <div class="flex items-center whitespace-nowrap">
                    ...
                    <div class="flex-shrink-0 flex items-center gap-4" style="padding-right: 7vw;">
                        ...
                        <div class="flex items-center gap-1.5 ml-2">
                            <a href="https://www.instagram.com/allround_english" target="_blank" rel="noopener" class="block w-[38px] h-[38px] hover:opacity-70 transition-opacity" aria-label="Instagram">
